  ...
  return (
    <div>
        ...
        <div class="p-3 mb-2 bg-light text-dark">
            ...
            <p>In the late 90s, nestled in the heart of Silicon Valley, Mark Hollis and his wife, Emily, embarked on a mission that would redefine the future of home automation. Their vision was nothing short of audacious: to develop the world's first smart home speaker, a device that would seamlessly integrate into our lives, making daily tasks more intuitive and connected.</p>
